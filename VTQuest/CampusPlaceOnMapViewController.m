//
//  CampusPlaceOnMapViewController.m
//  VTQuest
//
...
@interface CampusPlaceOnMapViewController ()

@end


@implementation CampusPlaceOnMapViewController

#pragma mark - View Life Cycle

- (void)viewDidLoad
{
    self.title = self.selectedPlaceName;
    
    // Ask the web view object to show the result of the Google Map Query
